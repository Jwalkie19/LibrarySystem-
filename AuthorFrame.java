...
/**
 *
 * hi guys it's me ya boy Bob Sheldon back at it again with a vanishing act
 */
public class AuthorFrame {
    public static void createFrame(int noa, int index, int ID)
    {
        EventQueue.invokeLater(new Runnable()
        {
            ...
            public void run()
            {
                JFrame frame = new JFrame("Author Name Entry");
